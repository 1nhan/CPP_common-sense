...
*	
*	발명자가 요구한 총 쌀 수를 계산해보세요. 
*	이 수는 너무 커서 int나 double로 정확히 표현할 수 없습니다. 
*	값이 너무 커졌을 때 int와 double에서 어떤 일이 발생하는지 관찰하세요.
